...
func (h *userHandler) Create(c *gin.Context) {
	...
	// karena tipe userService.RegisterUser adalah RegisterUserInput jadi harus di mapping dlu seperti di atas
	...
	c.Redirect(http.StatusFound, "/users") // redirect ke halaman user

}

func (h *userHandler) Edit(c *gin.Context) {
	idParam := c.Param("id") //di dapat di routing router.GET("/users/edit/:id", userWebHandler.Edit)
	...
	// karena di struct user tidak ada field error jadi harus di passing ke input yang memiliki field error
